...
<div class="container my-4">
    <div class="row">
        <div class="col-lg-12">
            <div class="cart-table" style="maring-top:200px;display: block !important; opacity: 1 !important; visibility: visible !important; position: relative !important;">
                <table class="table" style="display: table !important; opacity: 1 !important; visibility: visible !important; width: 100% !important;">
                    ...
                    <tr style="display: table-row !important; opacity: 1 !important; visibility: visible !important;">
                        <th scope="col" style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; background: #f5f5f5 !important; border: 1px solid #ddd !important;">Rasm</th>
                        <th scope="col" style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; background: #f5f5f5 !important; border: 1px solid #ddd !important;">Nomi</th>
                        <th scope="col" style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; background: #f5f5f5 !important; border: 1px solid #ddd !important;">Narxi</th>
                        <th scope="col" style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; background: #f5f5f5 !important; border: 1px solid #ddd !important;">Soni</th>
                        <th scope="col" style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; background: #f5f5f5 !important; border: 1px solid #ddd !important;">Jami Summa</th>
                    </tr>
                    </thead>
                    ...
                    <?php foreach ($models as $model): ?>
                        <tr style="display: table-row !important; opacity: 1 !important; visibility: visible !important;">
                            ...
                            <td style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; border: 1px solid #ddd !important;">
                                <?=number_format($model->product->price, 0, ',', ' ')?> So`m
                            </td>
                            <td style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; border: 1px solid #ddd !important;">
                                <?=$model->qty?>
                            </td>
                            <td style="display: table-cell !important; opacity: 1 !important; visibility: visible !important; padding: 10px !important; border: 1px solid #ddd !important;">
                                <?=number_format($model->product->price * $model->qty, 0, ',', ' ')?> So`m
                            </td>
                        </tr>
                    <?php endforeach; ?>
